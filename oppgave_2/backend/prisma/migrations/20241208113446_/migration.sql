/*
  ...
  - You are about to drop the column `allowedWeekdays` on the `Template` table. All the data in the column will be lost.
...
CREATE TABLE "new_Template" (
    ...
    "allowedDays" TEXT NOT NULL DEFAULT '0,1,2,3,4,5,6',
