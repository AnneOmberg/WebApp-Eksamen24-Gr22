...
INSERT INTO "new_Event" ("createdById", "description", "id", "location", "templateId", "title", "venueId") SELECT "createdById", "description", "id", "location", "templateId", "title", "venueId" FROM "Event";
DROP TABLE "Event";
